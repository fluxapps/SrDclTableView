...
//...
use srag\ActiveRecordConfig\SrDclTableView\ActiveRecordConfig;
//...
...
```php
//...
use srag\ActiveRecordConfig\SrDclTableView\ActiveRecordConfigGUI;
//...
...
namespace srag\Plugins\X\Config
//...
use srag\ActiveRecordConfig\SrDclTableView\ActiveRecordConfigFormGUI;
//...
...
namespace srag\Plugins\X\Config
//...
use srag\ActiveRecordConfig\SrDclTableView\ActiveRecordConfigTableGUI;
//...
...
if (\srag\DIC\SrDclTableView\DICStatic::dic()->database()->tableExists(\srag\Plugins\X\Config\ConfigOld::TABLE_NAME)) {
    ...
    \srag\DIC\SrDclTableView\DICStatic::dic()->database()->dropTable(\srag\Plugins\X\Config\ConfigOld::TABLE_NAME);
}
?>
```
