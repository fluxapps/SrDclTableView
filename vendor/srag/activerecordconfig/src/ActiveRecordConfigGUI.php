...
namespace srag\ActiveRecordConfig\SrDclTableView;

use ilPluginConfigGUI;
use ilUtil;
use srag\ActiveRecordConfig\SrDclTableView\Exception\ActiveRecordConfigException;
use srag\DIC\SrDclTableView\DICTrait;

/**
 * Class ActiveRecordConfigGUI
 *
 * @package srag\ActiveRecordConfig\SrDclTableView
 *
