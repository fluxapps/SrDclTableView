...
namespace srag\CustomInputGUIs\SrDclTableView\TableGUI;

use ilCSVWriter;
use ilExcel;
use ilFormPropertyGUI;
use ilTable2GUI;
use srag\CustomInputGUIs\SrDclTableView\PropertyFormGUI\Items\Items;
use srag\CustomInputGUIs\SrDclTableView\PropertyFormGUI\PropertyFormGUI;
use srag\CustomInputGUIs\SrDclTableView\TableGUI\Exception\TableGUIException;
use srag\DIC\SrDclTableView\DICTrait;

/**
 * Class TableGUI
 *
 * @package srag\CustomInputGUIs\SrDclTableView\TableGUI
 *
